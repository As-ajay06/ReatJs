...
function App() {
  ...
  const [password, setPassword] = useState("gwegeigerrgnwe")
  ...
  const copyPasswordToClippboard = useCallback(() => {
  ...
  return (
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500'>
      ...
      <div className='flex shadow rounded-lg overflow-hidden mb-4'>
        ...
        <button onClick={copyPasswordToClippboard} className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0'>copy</button>
      </div>
